"""
qti21_generator.py: This module defines the QTI21Generator class, which is responsible for generating QTI 2.1 compliant XML from parsed questions.

The QTI21Generator class provides methods to create the necessary XML structure required for QTI 2.1 packages, ensuring that the output is compatible with modern learning management systems.
...
Example Usage:
    >>> from txttoqti.qti21_generator import QTI21Generator
    >>> generator = QTI21Generator()
...
class QTI21Generator:
    """Generate QTI 2.1 compliant XML from parsed questions."""
    
    def __init__(self):
        self.logger = get_logger(__name__)
        
    def generate_qti_xml(self, parsed_questions: List[Question], assessment_title: str = "Assessment") -> str:
        """
    ...
    def generate(self, questions: List[Question], assessment_title: str = "Assessment") -> str:
        """
